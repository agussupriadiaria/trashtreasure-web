<?php
    ...
    if (isset($_POST['register'])) {
        ...
        try {
            ...
            $stmt->bind_param("ssssss", $fullname, $phone, $username, $address, $email, $password);
            // Eksekusi query
            if ($stmt->execute()) {
        ...
        // Jika menggunakan sql harus ditutup jika sudah tak digunakan ========
        $db->close(); 
    ...
    <header>
        ...
        <nav>
            <ul id="menu">
                ...
                <li><a href="register.php" class="menu-link active">Register</a></li>
            </ul>
        </nav>
    </header>
